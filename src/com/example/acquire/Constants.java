...
public class Constants{
	public static final String VERSION = "2015.10.17-1";
	
	public static final int REQUEST_ENABLE_BLUETOOTH = 1;
	public static final int REQUEST_DETAILS = 2;
	public static final int REQUEST_BTDEVICE = 3;
	public static final int REQUEST_WIFIDEVICE = 4;
	public static final int REQUEST_WIFISSID = 5;
