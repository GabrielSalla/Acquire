...
public class MainActivity extends Activity implements OnItemClickListener{
	...
	private void init(){
		//super teste pra testar o github!
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent result){
		...
		if(requestCode == Constants.REQUEST_DETAILS){
			...
			if(resultCode == RESULT_OK){
				...
				String customName = result.getStringExtra("customName");
				
				//Changes the custom name in the database if is saving
				acqService.ChangeCustomName(posDetails, customName);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,	long id){
		...
		details.putExtra("name", itemList.get(position).getName());
		details.putExtra("customName", itemList.get(position).getCustomName());
		details.putExtra("description", itemList.get(position).getDescription());
		startActivityForResult(details, Constants.REQUEST_DETAILS);
